...
class Admin_user extends CI_Controller {
    ...
    public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            $upload_avatar = $this->uploadImageFile('avatar');
            $upload_cover_photo = $this->uploadImageFile('cover_photo');
            ...
            $this->form_validation->set_rules('user_bio', 'User Bio', 'required');
