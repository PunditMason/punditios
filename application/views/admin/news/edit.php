 <!-- page content -->
    ...
    <div class="container top">
        ...
        echo form_open('admin/news/update/' . $this->uri->segment(4) . '', $attributes);
        ?>
        <fieldset>
            <div class="control-group">
                <label for="inputError" class="control-label">Title</label>
                <div class="controls">
                    <input type="text" class="admin-input-text" id="" name="title" value="<?php echo $news[0]['title']; ?>" >
                </div>
            </div>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                    <textarea class="admin-input-text" id="" name="content" value="<?php echo $news[0]['content']; ?>" ><?php echo $news[0]['content']; ?></textarea>
                </div>
            </div>
