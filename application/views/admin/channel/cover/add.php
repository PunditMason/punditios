        ...
        <fieldset>
           ...
           <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="file" class="admin-input-text" id="" name="listeners" value="<?php echo set_value('listeners'); ?>" >
                </div>
            </div>
            <div class="control-group">
                <label for="inputError" class="control-label">Listeners Icon</label>
                <div class="controls">
                    <input type="file" class="admin-input-text" id="" name="broadcaster" value="<?php echo set_value('broadcaster'); ?>" >
                </div>
            </div>
