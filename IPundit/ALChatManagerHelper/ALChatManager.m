...
//    [ALApplozicSettings setStatusBarStyle:UIStatusBarStyleLightContent];
    ...
    //[ALApplozicSettings setColorForNavigation:[UIColor colorWithRed:66.0/255 green:173.0/255 blue:247.0/255 alpha:1]];
     [ALApplozicSettings setColorForNavigation:[UIColor lightGrayColor]];
    ...
    [ALApplozicSettings setTitleForBackButtonChatVC:@"X"];               /*  SET BACK BUTTON FOR CHAT VC */
    /****************************************************************************************************************/
    ...
    [ALApplozicSettings setReceiveMsgTextColor:[UIColor whiteColor]];
...
//  [ALApplozicSettings setColorForSendMessages:[UIColor colorWithRed:66.0/255 green:173.0/255 blue:247.0/255 alpha:1]];
     [ALApplozicSettings setColorForReceiveMessages:[UIColor colorWithRed:101/255 green:101/255 blue:101/255 alpha:1]];
    
    [ALApplozicSettings setColorForSendMessages:[UIColor colorWithRed:52/255 green:52/255 blue:52/255 alpha:1]];
    
    [ALApplozicSettings setCustomMessageBackgroundColor:[UIColor lightTextColor]];              /*  SET CUSTOM MESSAGE COLOR */
    [ALApplozicSettings setCustomMessageFontSize:12];                                     /*  SET CUSTOM MESSAGE FONT SIZE */
    ...
    [ALApplozicSettings setDateColor:[UIColor grayColor]];
    
    //****************** MESSAGE SEPERATE DATE COLOUR : DATE MESSAGE ******************/
    [ALApplozicSettings setMsgDateColor:[UIColor grayColor]];
    ...
    UIColor * sendButtonColor = [UIColor colorWithRed:5.0/255 green:173.0/255 blue:247.0/255 alpha:1]; /*  SET COLOR FOR SEND BUTTON   */
    ...
    [ALApplozicSettings setPlaceHolderColor:[UIColor lightGrayColor]];               /*  SET COLOR FOR PLACEHOLDER TEXT */
 ...
 //   [ALApplozicSettings setTextColorForTypingLabel:[UIColor colorWithRed:51.0/255 green:51.0/255 blue:51.0/255 alpha:0.5]]; /*  SET COLOR FOR TEXT TYPING LABEL  */
    ...
    [ALApplozicSettings setBGColorForTypingLabel:[UIColor clearColor]]; /*  SET COLOR FOR TYPING LABEL  */

    [ALApplozicSettings setTextColorForTypingLabel:[UIColor whiteColor]]; /*  SET COLOR FOR TEXT TYPING LABEL  */
    /****************************************************************************************************************/
    ...
    [ALApplozicSettings setChatWallpaperImageName:@"ChatOverlay"];
    /****************************************************************************************************************/
