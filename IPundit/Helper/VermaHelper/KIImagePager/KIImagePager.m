...
- (void) initalizeImageCounter
{
    ...
    _imageCounterBackground.alpha = 0.5f;
    _imageCounterBackground.layer.cornerRadius = 10.0f;
    ...
    if([aImageUrls count] > 0) {
        ...
        for (int i = 0; i < [aImageUrls count]; i++) {
            ...
            if([[aImageUrls objectAtIndex:i] isKindOfClass:[UIImage class]]) {
                ...
                [imageView setImage:(UIImage *)[UIImage imageNamed:@"No-photos.png"]];
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            if(completion){
                if (imageData) {
                    ...
                    UIImage *UserImage =  [UIImage imageNamed:@"No-photos.png"];
                    NSData *imageDataa = UIImageJPEGRepresentation(UserImage, 0.8f);
                    completion([UIImage imageWithData:imageDataa],nil);
                }
