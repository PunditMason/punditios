...
-(void)viewDidLoad
{
    ...
    button.frame = CGRectMake(282, 8, 30, 30);
    [button setImage:[UIImage imageNamed:@"closechat.png"] forState:UIControlStateNormal];
        ...
        [AVCaptureDevice requestAccessForMediaType:AVMediaTypeVideo completionHandler:^(BOOL granted) {
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                if (granted)
                {
                    ...
                    self.mImagePicker.modalPresentationStyle = UIModalPresentationOverCurrentContext;
